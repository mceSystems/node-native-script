...
ObjCBlockType* TypeFactory::parseBlockType(JSC::JSGlobalObject* globalObject, const TypeEncodingsList<uint8_t>& typeEncodings) {
...
ObjCBlockType* TypeFactory::getObjCBlockType(JSC::JSGlobalObject* globalObject, JSCell* returnType, WTF::Vector<JSCell*> parametersTypes) {
...
JSCell* TypeFactory::parseFunctionReferenceType(JSC::JSGlobalObject* globalObject, const TypeEncodingsList<uint8_t>& typeEncodings) {
    NativeScriptRuntime* runtime = NativeScriptRuntime::getRuntime(globalObject);
    const TypeEncoding* typeEncodingPtr = typeEncodings.first();
    JSCell* returnType = runtime->typeFactory()->parseType(globalObject, typeEncodingPtr, false);
    const WTF::Vector<JSCell*> parameterTypes = runtime->typeFactory()->parseTypes(globalObject, typeEncodingPtr, typeEncodings.count - 1, false);
    return this->getFunctionReferenceTypeInstance(globalObject, returnType, parameterTypes);
}

FunctionReferenceTypeInstance* TypeFactory::getFunctionReferenceTypeInstance(JSC::JSGlobalObject* globalObject, JSCell* returnType, WTF::Vector<JSCell*> parametersTypes) {
    WTF::Vector<JSC::WeakImpl*> weakParametersTypes;
    weakParametersTypes.append(WeakSet::allocate(JSValue(returnType))); // add return value
    for (size_t i = 0; i < parametersTypes.size(); i++) {
        weakParametersTypes.append(WeakSet::allocate(JSValue(parametersTypes[i])));
...
RecordConstructor* TypeFactory::getStructConstructor(JSC::JSGlobalObject* globalObject, const WTF::String& structName) {
...
RecordConstructor* TypeFactory::getAnonymousStructConstructor(JSC::JSGlobalObject* globalObject, const Metadata::TypeEncodingDetails::AnonymousRecordDetails& details) {
    ffi_type* ffiType = new ffi_type({ .size = 0,
                                       .alignment = 0,
                                       .type = FFI_TYPE_STRUCT });
...
WTF::Vector<RecordField*> TypeFactory::createRecordFields(JSC::JSGlobalObject* globalObject, const WTF::Vector<JSCell*>& fieldsTypes, const WTF::Vector<WTF::String>& fieldsNames, ffi_type* ffiType) {
...
ObjCConstructorNative* TypeFactory::getObjCNativeConstructor(JSC::JSGlobalObject* globalObject, const WTF::String& klassName) {
...
ObjCConstructorNative* TypeFactory::NSObjectConstructor(JSC::JSGlobalObject* globalObject) {
...
IndexedRefTypeInstance* TypeFactory::getIndexedRefType(JSC::JSGlobalObject* globalObject, JSCell* innerType, size_t typeSize) {
...
ExtVectorTypeInstance* TypeFactory::getExtVectorType(JSC::JSGlobalObject* globalObject, JSCell* innerType, size_t typeSize) {
...
ReferenceTypeInstance* TypeFactory::getReferenceType(JSC::JSGlobalObject* globalObject, JSCell* innerType) {
...
JSC::JSCell* TypeFactory::parseType(JSC::JSGlobalObject* globalObject, const Metadata::TypeEncoding*& typeEncoding, bool isStructMember) {
    DeferGCForAWhile deferGC(globalObject->vm().heap);
...
const WTF::Vector<JSC::JSCell*> TypeFactory::parseTypes(JSC::JSGlobalObject* globalObject, const Metadata::TypeEncoding*& typeEncodings, int count, bool isStructMember) {
    DeferGCForAWhile deferGC(globalObject->vm().heap);
...
void TypeFactory::finishCreation(VM& vm, JSC::JSGlobalObject* globalObject) {
