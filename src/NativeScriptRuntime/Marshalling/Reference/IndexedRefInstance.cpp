...
void IndexedRefInstance::createBackingStorage(VM& vm, ExecState* execState, JSCell* innerType) {
    this->setType(vm, innerType);
    ...
    this->_pointer.set(vm, this, jsCast<PointerInstance*>(runtime->interop()->pointerInstanceForPointer(vm, data)));
