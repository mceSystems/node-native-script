...
EncodedJSValue JSC_HOST_CALL FunctionReferenceConstructor::constructFunctionReferenceInstance(ExecState* execState) {
    ...
    FunctionReferenceInstance* functionReference = FunctionReferenceInstance::create(execState->vm(), execState->lexicalGlobalObject(), runtime->interop()->functionReferenceInstanceStructure(), func);
