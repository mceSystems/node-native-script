...
public:
	...
	{
		return NativeScriptRuntime::getRuntime(&vm)->recordProtoFieldGetterSetterSpace();
	}
...
static_assert(sizeof(RecordProtoFieldGetter) == sizeof(RecordProtoFieldSetter), "RecordProtoFieldGetter and RecordProtoFieldSetter must have the same size in order to share the same JSC::IsoSubspace");
