...
public:
    ...
    static TypeFactory* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure) {
    ...
    JSC::JSCell* parseType(JSC::JSGlobalObject*, const Metadata::TypeEncoding*&, bool isStructMember);

    const WTF::Vector<JSC::JSCell*> parseTypes(JSC::JSGlobalObject*, const Metadata::TypeEncoding*& typeEncodings, int count, bool isStructMember);

    ObjCConstructorNative* getObjCNativeConstructor(JSC::JSGlobalObject*, const WTF::String& klassName);

    RecordConstructor* getStructConstructor(JSC::JSGlobalObject*, const WTF::String& structName);

    ObjCConstructorNative* NSObjectConstructor(JSC::JSGlobalObject*);

    ReferenceTypeInstance* getReferenceType(JSC::JSGlobalObject* globalObject, JSC::JSCell* innerType);

    IndexedRefTypeInstance* getIndexedRefType(JSC::JSGlobalObject* globalObject, JSCell* innerType, size_t typeSize);

    ExtVectorTypeInstance* getExtVectorType(JSC::JSGlobalObject* globalObject, JSCell* innerType, size_t typeSize);

    FunctionReferenceTypeInstance* getFunctionReferenceTypeInstance(JSC::JSGlobalObject* globalObject, JSC::JSCell* returnType, WTF::Vector<JSCell*> parametersTypes);

    ObjCBlockType* getObjCBlockType(JSC::JSGlobalObject* globalObject, JSCell* returnType, WTF::Vector<JSCell*> parametersTypes);
...
private:
    ...
    WTF::Vector<RecordField*> createRecordFields(JSC::JSGlobalObject*, const WTF::Vector<JSCell*>& fieldsTypes, const WTF::Vector<WTF::String>& fieldsNames, ffi_type* ffiType);

    ObjCBlockType* parseBlockType(JSC::JSGlobalObject*, const Metadata::TypeEncodingsList<uint8_t>& typeEncodings);

    JSC::JSCell* parseFunctionReferenceType(JSC::JSGlobalObject* globalObject, const Metadata::TypeEncodingsList<uint8_t>& typeEncodings);

    RecordConstructor* getAnonymousStructConstructor(JSC::JSGlobalObject*, const Metadata::TypeEncodingDetails::AnonymousRecordDetails& details);
