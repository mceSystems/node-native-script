...
public:
    ...
    static AllocatedPlaceholder* create(JSC::VM& vm, JSC::Structure* structure, id wrappedObject, JSC::Structure* instanceStructure) {
        AllocatedPlaceholder* object = new (NotNull, JSC::allocateCell<AllocatedPlaceholder>(vm.heap)) AllocatedPlaceholder(vm, structure);
        object->finishCreation(vm, wrappedObject, instanceStructure);
        return object;
    }
...
private:
    ...
    void finishCreation(JSC::VM& vm, id wrappedObject, JSC::Structure* instanceStructure) {
