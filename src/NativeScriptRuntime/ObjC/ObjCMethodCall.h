...
public:
	...
	{
		return NativeScriptRuntime::getRuntime(&vm)->objCMethodCallSpace();
	}

    static ObjCMethodCall* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure, const Metadata::MethodMeta* metadata) {
...
private:
    ...
    void finishCreation(JSC::VM&, JSC::JSGlobalObject*, const Metadata::MethodMeta*);
