...
void ObjCMethodCall::finishCreation(VM& vm, JSC::JSGlobalObject* globalObject, const MethodMeta* metadata) {
    ...
    const WTF::Vector<JSCell*> parameterTypesCells = runtime->typeFactory()->parseTypes(globalObject, encodings, metadata->encodings()->count - 1, false);
